...
const (
	...
	mainPkg = "bitlaunch"
	// modules:
	mainMod = "index" // the bitlaunch module
)

//go:embed cmd/pulumi-resource-bitlaunch/bridge-metadata.json
var metadata []byte
...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		//
		//    - In provider/cmd/pulumi-tfgen-bitlaunch/main.go, replace the
		...
		//
		//    - In provider/cmd/pulumi-resource-bitlaunch/main.go, replace the
		...
		//
		//      	tfbridge.Main(context.Background(), "bitlaunch", bitlaunch.Provider(),
		...
		// convention is to have a function at "github.com/iwahbe/terraform-provider-bitlaunch/provider".New
		...
		//
		//nolint:lll
		P: shimv2.NewProvider(bitlaunch.New(version.Version)()),
		...
		Keywords:   []string{"webwarrior-ws", "bitlaunch", "category/cloud"},
		License:    "Apache-2.0",
		...
		Golang: &tfbridge.GolangInfo{
			ImportBasePath: path.Join(
				"github.com/webwarrior-ws/pulumi-bitlaunch/sdk/",
	...
	prov.MustComputeTokens(tokens.SingleModule("bitlaunch_", mainMod,
