...
namespace Pulumi.Bitlaunch
{
    ...
    /// </summary>
    [BitlaunchResourceType("bitlaunch:index/sshkey:Sshkey")]
    public partial class Sshkey : global::Pulumi.CustomResource
    {
        ...
        public Sshkey(string name, SshkeyArgs args, CustomResourceOptions? options = null)
            : base("bitlaunch:index/sshkey:Sshkey", name, args ?? new SshkeyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Sshkey(string name, Input<string> id, SshkeyState? state = null, CustomResourceOptions? options = null)
            : base("bitlaunch:index/sshkey:Sshkey", name, state, MakeResourceOptions(options, id))
        {
        }
